        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsReverseHex = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "((1))"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    zh_CN = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    zh_HK = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    en_US = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IndustryIdArr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MainComIdArr = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxLeaveDaySpan = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false, comment: "累計的時長：年假10天，標準工作時間8小時，則對應的值等於80小時 "),
                    MaxLeaveNatureWorkDay = table.Column<decimal>(type: "decimal(4,2)", nullable: false, comment: "如 3-8婦女節 半天假期 = 0.5 個工作日 換算成 MaxLeaveDaySpan =  0.5*GlobalConfig.StandardWorkDaySpan(8小時) 即4小時 "),
                    IsForTotal = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "((1))", comment: "是否允許與其他累計 如果統計總的請假天數則視乎此值"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CIC_ReferenceNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ContractorNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ServiceStartDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    ServiceEndDate = table.Column<DateTime>(type: "datetime", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovedBy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ApprovedStatus = table.Column<int>(type: "int", nullable: true, defaultValueSql: "((0))"),
                    OperateDateTime = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())"),
                    MainComId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
