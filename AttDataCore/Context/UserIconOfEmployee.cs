        ...
        public UserIconOfEmployee(string EmployeeId)
        {
            ...
            else
            {
                ...
                if (employee != null)
                {
                    ...
                    uploadItems = uploadItems.Where(c => c.TargetTalbeKeyId.Contains(EmployeeId)).OrderByDescending(c => c.OperatedDate).ThenByDescending(c => c.RankOrder).Take(3).ToList();
                    int i = 0;
